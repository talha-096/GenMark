    ...
    return (
        <div className="flex flex-col h-full gap-6 max-w-4xl mx-auto w-full">
            <div className="mb-4 text-center">
               <h2 className="text-3xl font-display font-semibold mb-2">Generative Profile</h2>
            </div>
            ...
            <GlassCard variant="featured" className="p-8 flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="text-center md:text-left">
                   ...
                   <div className="flex gap-2 flex-wrap justify-center md:justify-start mt-3">
                       <span className="text-muted-foreground px-3 py-1 bg-glass/5 border border-glass/10 rounded-full text-xs font-mono uppercase">
                ...
                <div className="ml-auto flex gap-3">
                    <button 
                        className="bg-glass/5 border border-glass/10 px-6 py-2 rounded-lg hover:bg-glass/10 transition-colors"
