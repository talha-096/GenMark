...
class Config:
    ...
    # All AI generation is routed through the Kaggle notebook's ngrok tunnel.
    # No direct API keys (Gemini, OpenAI, etc.) are needed on the backend.
    KAGGLE_MODEL_URL = os.getenv('KAGGLE_MODEL_URL')
